...
<body>
  ...
  <?php if (!empty($success_message)): ?>
    ...
    <?php if (!empty($error_message)): ?>
        <div id="toast-error" class="fixed top-5 right-5 bg-red-500 text-white px-4 py-3 rounded shadow-lg">
          ...
          <div class="grid md:grid-cols-2 items-center gap-4 max-md:gap-8 max-w-6xl max-md:max-w-lg w-full p-4 m-4 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-md">
            ...
            <form method="POST" action="login.php">
                <div class="mb-12">
                  ...
                  <p class="text-sm mt-4 text-gray-800">Don't have an account <a href="/php/register_form.php" class="text-blue-600 font-semibold hover:underline ml-1 whitespace-nowrap">Register here</a></p>
                </div>
