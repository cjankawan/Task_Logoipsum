...
<body>
  ...
  <?php if (!empty($error_message)): ?>
        <div id="toast" class="fixed top-5 right-5 bg-red-500 text-white px-4 py-3 rounded shadow-lg">
    ...
    <div class="font-[sans-serif] bg-white md:h-screen">
        <div class="grid md:grid-cols-2 items-center gap-8 h-full">
          ...
          <div class="flex items-center p-6 h-full w-full">
            <form class="max-w-lg w-full mx-auto" action="register.php" method="POST">
              <div class="mb-8">
              ...
              <div class="mt-8">
                ...
                <p class="text-sm mt-6 text-gray-800">Already have an account? <a href="/php/login.php" class="text-blue-500 font-semibold hover:underline ml-1">Login here</a></p>
              </div>
            </form>
          </div>
        </div>
